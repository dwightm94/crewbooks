...
import {
  Sun, Moon, Building2, ExternalLink, Bell, Shield,
          ...
          <div className="px-4 pb-4">
            <div className="flex items-center gap-2.5 pt-3" style={{ borderTop:"1px solid var(--border)" }}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px]" style={{ color:"var(--text3, var(--muted))" }}>{trade || "Set your trade"}</p>
              </div>
...
function UpgradeBanner() {
  ...
  return (
    <button onClick={() => router.push("/upgrade")} className="w-full flex items-center justify-between p-4 rounded-2xl text-left"
      ...
      <div className="px-4 py-2 rounded-xl text-sm font-bold text-white flex-shrink-0" style={{ background:"var(--brand)" }}>Upgrade</div>
    </button>
  );
}
