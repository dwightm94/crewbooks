...
export default function LoginPage() {
  ...
  const handleGoogle = () => {
    ...
    const url = `${cognitoDomain}/oauth2/authorize?response_type=code&client_id=${clientId}&redirect_uri=${encodeURIComponent(redirectUri)}&prompt=select_account&identity_provider=Google&scope=email+openid+profile`;
