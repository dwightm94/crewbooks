...
export const metadata = { title: "CrewBooks", description: "Jobs, invoices, and crew — all in one place.", manifest: "/manifest.json", themeColor: "#F59E0B", icons: { icon: "/favicon.png", apple: "/favicon.png" } };
