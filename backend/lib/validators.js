...
function validateExpense(d) { const e = []; if (!d.description?.trim()) e.push("Description required"); if (!d.amount || isNaN(d.amount) || d.amount <= 0) e.push("Valid amount required"); return e; }
